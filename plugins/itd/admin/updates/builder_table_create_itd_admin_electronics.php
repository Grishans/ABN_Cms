...
class BuilderTableCreateItdAdminElectronics extends Migration
{
    public function up()
    {
        Schema::create('itd_admin_electronics', function($table)
        {
            $table->engine = 'InnoDB';
            ...
            $table->string('subtitle_page_2', 100);
            $table->string('subdesc_page_2', 100);
    ...
    {
        Schema::dropIfExists('itd_admin_electronics');
    }
}
